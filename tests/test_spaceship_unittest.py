...
class TestSpaceship(unittest.TestCase):
    ...
    def test_ship_image_change(self):
        ...
        self.assertEqual(self.ship.select_ship_image(), 0)
        self.ship.health = 81
        self.assertEqual(self.ship.select_ship_image(), 0)
        self.ship.health = 80
        self.assertEqual(self.ship.select_ship_image(), 1)
        self.ship.health = 51
        self.assertEqual(self.ship.select_ship_image(), 1)
        self.ship.health = 50
        self.assertEqual(self.ship.select_ship_image(), 2)
        self.ship.health = 21
        self.assertEqual(self.ship.select_ship_image(), 2)
        self.ship.health = 20
        self.assertEqual(self.ship.select_ship_image(), 3)
